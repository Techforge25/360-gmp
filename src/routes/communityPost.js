...
communityPostRouter.route("/community/:communityId").get(authentication, authorization(["user", "business"]), getCommunityPosts);
...
// Add vote to a poll option
communityPostRouter.route("/:postId/vote").post(authentication, addVote);
