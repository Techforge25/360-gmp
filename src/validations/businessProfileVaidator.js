...
const createBusinessProfileSchema = joi.object({
    ...
    headOffice: joi.object({
        ...
        addressLine: joi.string().min(10).max(200).trim().required().label("Head office address line"),
    ...
    internationalOffices: joi.array().max(5).items(joi.object({
        ...
        addressLine: joi.string().trim().min(10).optional().max(200).allow("", null).label("Address line"), 
